...
class AWelcome extends React.Component
{
    constructor(props){
        super(props);
        this.state =
         ...
         <div className="container-fluid welcome"> 
           <div className="row welcome-back">
             ...
             <div className="col-12 col-md-7  heading text-white">
               ...
               <br></br><br></br>
               <br></br>
                <button className="btn btn-lg btn-outline-secondary log-button text-white"
                    onClick={() => this.handleClick()} type="button">Attend</button>
             </div>
             <div className="col-12 col-md-5 ">
               <img className="logo" src={logo} alt="logo"></img>
                         </div>
              <div className="text-white col-12 text-center">
                <p className="intro-line">Create and Share Forms and Certificates!!</p>
              </div>
           </div>
         </div>
        );
